...
def rmsprop(w, dw, config=None):
  ...
  # ================================================================ #
  a = config['decay_rate'] * config['a'] + (1 - config['decay_rate']) * dw**2
  config['a'] = a
...
def adam(w, dw, config=None):
  ...
  a = config['beta2'] * config['a'] + (1 - config['beta1']) * (dw**2)
  config['t'] += 1
  v_wave = v / (1 - config['beta1']**config['t'])
  a_wave = a / (1 - config['beta2']**config['t'])
  next_w = w - config['learning_rate'] * v_wave / (np.sqrt(a_wave) + config['epsilon'])
  config['v'] = v
  config['a'] = a
